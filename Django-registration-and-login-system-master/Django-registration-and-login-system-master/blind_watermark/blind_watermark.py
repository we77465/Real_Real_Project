...
from .ascii import ascii_to_int
...
class WaterMark:
    def __init__(self, password_wm=1, password_img=1, block_shape=(4, 4), mode='common', processes=None):
        ...
        #random seed(int)
        self.password_wm_int = ascii_to_int(self.password_wm)
    ...
    def read_wm(self, wm_content, mode='img'):
        ...
        if mode == 'img':
            ...
            # 加密aes
            wm_content = encrypt(wm_content, self.password_wm)
        ...
        # 水印加密:
        np.random.RandomState(self.password_wm_int).shuffle(self.wm_bit)
    ...
    def extract_decrypt(self, wm_avg):
        ...
        np.random.RandomState(self.password_wm_int).shuffle(wm_index)
    ...
    def extract(self, filename=None, embed_img=None, wm_shape=None, out_wm_name=None, mode='img'):
        ...
        if mode == 'img':
            ...
            #解密aes
            wm_decrypt = decrypt(wm, self.password_wm)
